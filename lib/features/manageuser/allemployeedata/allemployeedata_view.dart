...
class AllEmployeeDataView extends GetView<AllEmployeeDataController> {
  const AllEmployeeDataView({super.key});
      ...
      child: Column(
        children: [
          Expanded(
            ...
            return const Center(child: Text('No employee added yet'));
          }
